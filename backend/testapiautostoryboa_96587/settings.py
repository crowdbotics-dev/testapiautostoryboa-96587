"""
Django settings for testapiautostoryboa_96587 project.
...
ROOT_URLCONF = 'testapiautostoryboa_96587.urls'
...
WSGI_APPLICATION = 'testapiautostoryboa_96587.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapiautostoryboa_96587 API",
    "DESCRIPTION": "API documentation for testapiautostoryboa_96587 App",
    "VERSION": "v1",
}
