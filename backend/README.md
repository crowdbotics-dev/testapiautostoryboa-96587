...
## Project Structure
    ...
    ├── testapiautostoryboa_96587  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_96587`
...
2. Clone this repo and `cd testapiautostoryboa_96587`
